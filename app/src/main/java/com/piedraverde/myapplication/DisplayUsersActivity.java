...
public class DisplayUsersActivity extends AppCompatActivity {
    ...
    private class ListViewAdapter extends ArrayAdapter {
        ...
        TextView tvName, tvGender , tvUsername;
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            tvName.setText(objects.get(position).get(db.TBL_USERS_NAME));
            tvUsername.setText(objects.get(position).get(db.TBL_USERS_USERNAME));
            tvGender.setText(objects.get(position).get(db.TBL_USERS_GENDER));
            ...
            case R.id.btnLogout:
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        shared.edit().remove(db.TBL_USERS_ID).commit();
                        Toast.makeText(DisplayUsersActivity.this, "You have successfully logged out", Toast.LENGTH_SHORT).show();
