...
public class EditUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etUsername.setText(selected_user.get(0).get(db.TBL_USERS_USERNAME));
        etPassword.setText(selected_user.get(0).get(db.TBL_USERS_PASSWORD));
        etConfirmPassword.setText(selected_user.get(0).get(db.TBL_USERS_PASSWORD));
        etName.setText(selected_user.get(0).get(db.TBL_USERS_NAME));
        if (selected_user.get(0).get(db.TBL_USERS_GENDER).equals("Female")){
        ...
        switch (item.getItemId()){
            case R.id.btnSave:
                ...
                if(formsuccess == 5){
                    ...
                    map_user.put(db.TBL_USERS_NAME, name);
                    map_user.put(db.TBL_USERS_GENDER, gender);
